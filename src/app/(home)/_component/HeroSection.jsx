        ...
        <div className="text-center">
          ...
          >
            ...
            >
              ...
              <Zap className="relative z-10 w-5 h-5 fill-current" aria-hidden="true" />
            ...
            <button 
              ...
              className="group inline-flex items-center gap-3 px-8 py-4 rounded-2xl text-white font-semibold text-lg border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all duration-300 backdrop-blur-sm w-full sm:w-auto justify-center"
            >
