...
import { X, PlusCircle, Upload, ImageIcon, LinkIcon, Loader2, RefreshCw } from "lucide-react";
...
const Slider = () => {
  ...
  const handleUpdate = async () => {
    try {
      setLoading(true);
      const res = await fetch(`${API_URL}/update`, { method: "PUT" });
      const result = await res.json();
      if (res.ok) {
        toast.success("Slider updated successfully!");
        fetchSlider(); // Refresh data
      } else {
        toast.error(result.message);
      }
    } catch (err) {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <h1 className="text-2xl font-bold text-gray-900 mt-2">Slider Images</h1>
          </div>
          <button
            onClick={fetchSlider}
            disabled={loading}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-8">
          ...
          <div className="text-sm text-blue-800 space-y-1">
            <p>• Maximum <b>3 images</b> allowed</p>
            <p>• Supported formats: <b>PNG, JPG, JPEG</b></p>
            <p>• Recommended size: <b>1298px × 482px</b></p>
        ...
        {/* Current Images Grid */}
        <div className="mb-8">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Current Slider Images ({slider.images?.length || 0}/3)</h2>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {slider.images?.map((img, index) => (
                <div key={img._id} className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-all group">
                  <div className="relative aspect-[1298/482] overflow-hidden">
                    ...
                    <button
                      ...
                      className="absolute top-3 right-3 bg-red-500 text-white p-2 rounded-full hover:bg-red-600 transition-all opacity-0 group-hover:opacity-100 transform scale-90 group-hover:scale-100"
                    >
                      <X size={16} />
                    </button>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-8">
          <h2 className="text-lg font-semibold text-gray-900 mb-6">Add New Image</h2>
                ...
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  {newImage ? (
                    <>
                      ...
                      <p className="text-sm font-medium text-green-700">{newImage.name}</p>
