...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const mockData = {
      ...
      salesTarget: 150000,
      recentOrders: [
        { id: 1, customer: 'রহিম করিম', amount: 2500, status: 'confirmed', date: '২০২৫-০১-১৫' },
        { id: 2, customer: 'সিমা আক্তার', amount: 1800, status: 'pending', date: '২০২৫-০১-১৫' },
        { id: 3, customer: 'জaved ইসলাম', amount: 3200, status: 'delivered', date: '২০২৫-০১-১৪' },
        { id: 4, customer: 'ফারহানা আহমেদ', amount: 1500, status: 'confirmed', date: '২০২৫-০১-১৪' }
      ],
      topProducts: [
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 bangla-text">ড্যাশবোর্ড লোড হচ্ছে...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        ...
        <div className="flex justify-between text-sm text-gray-600 mt-2">
          <span className="bangla-text">বর্তমান: ৳{current.toLocaleString()}</span>
          <span className="bangla-text">লক্ষ্য: ৳{target.toLocaleString()}</span>
        </div>
      </div>
    );
  };
  ...
  const OrderSourceCard = () => (
    <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
      <h3 className="font-semibold text-gray-900 mb-4 bangla-text">অর্ডার সোর্স</h3>
      <div className="space-y-4">
        {[
          { source: 'ল্যান্ডিং পেজ', value: dashboardData.orderSource.landingPage, icon: FiGlobe, color: 'bg-blue-500' },
          { source: 'ওয়েবসাইট', value: dashboardData.orderSource.website, icon: FiGlobe, color: 'bg-green-500' },
          { source: 'ফোন কল', value: dashboardData.orderSource.phoneCall, icon: FiPhone, color: 'bg-purple-500' },
          { source: 'সোশ্যাল মিডিয়া', value: dashboardData.orderSource.socialMedia, icon: FiShare2, color: 'bg-pink-500' }
        ].map((item, index) => (
          <div key={index}>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 bangla-text">ড্যাশবোর্ড ওভারভিউ</h1>
        <p className="text-gray-600 bangla-text">আপনার ব্যবসার সাম্প্রতিক পরিসংখ্যান এবং কর্মক্ষমতা</p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              <h3 className="font-semibold text-gray-900 mb-4 bangla-text">ভিজিটরস Today</h3>
              <div className="space-y-4">
                <StatCard
                  title="মোট ভিজিটর"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="p-6 border-b border-gray-200">
              <h3 className="font-semibold text-gray-900 bangla-text">সাম্প্রতিক অর্ডার</h3>
            </div>
              ...
              {dashboardData.recentOrders.map((order) => (
                <div key={order.id} className="p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="font-medium bangla-text">{order.customer}</p>
                    ...
                    <div className="text-right">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs ${
                        ...
                        {order.status === 'confirmed' ? 'নিশ্চিত' : 
                         order.status === 'pending' ? 'পেন্ডিং' : 'ডেলিভার্ড'}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="space-y-6">
          ...
          {/* Financial Summary */}
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-4 bangla-text">আর্থিক সারাংশ</h3>
            <div className="space-y-4">
              <StatCard
          ...
          {/* Delivery Report */}
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-4 bangla-text">ডেলিভারি রিপোর্ট</h3>
          ...
          <div className="space-y-4">
            ...
            />
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              <h3 className="font-semibold text-gray-900 mb-2 bangla-text">বিক্রয় লক্ষ্য</h3>
              ...
              <p className="text-sm text-gray-600 mt-2 bangla-text">
                মাসিক লক্ষ্য {((dashboardData.salesPerformance.current / dashboardData.salesTarget) * 100).toFixed(1)}% অর্জিত
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="p-6 border-b border-gray-200">
              <h3 className="font-semibold text-gray-900 bangla-text">টপ Selling পণ্য</h3>
            </div>
            <div className="divide-y divide-gray-200">
                ...
                <div key={index} className="p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{product.sales} বিক্রয়</p>
                    </div>
